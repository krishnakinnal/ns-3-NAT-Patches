...
public:
 ...
 /**
   ...
   *
   * \param Ipv4address first param for netid, second for the lower limit of globalip, third param for the upper limit of globalip
...
private:
  ...
  */
  ...
  uint16_t m_flag;
/* Packet drop decision is made inside Ipv4Nat::DoNatPostRouting. The boolean variable 'value' is set inside the Ipv4Nat::DoNatPreRouting whenever there is match in NAT Rules. If value is true, packet is accepted; if value is false, packet is dropped. */
  bool value;
